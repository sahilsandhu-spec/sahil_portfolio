...
| Four public-safe case studies | PRD FR-05, Content Strategy section 6; `docs/SahilSandhu.pdf` | `site/index.html` selected programs | Content review against disclosure rules | Implemented with resume-backed details |
| Public-safe technical imagery | User request on 7 August 2026 | `site/assets/images/*` and domain section | Asset and disclosure review | Implemented with generic SVG illustrations |
